(function ($) {
    ...
    <div class="customizer-links">
     <div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link" id="c-pills-home-tab" data-bs-toggle="pill" href="#c-pills-home" role="tab"
               aria-controls="c-pills-home" aria-selected="true" data-original-title="">
               <div class="settings">
                    <img class="img-fluid" src="../../backend/images/customizer/1.png" alt="nft">
               </div>
               ...
               <div class="tab-pane fade show active" id="c-pills-home" role="tabpanel"
                    ...
                    <ul class="layout-grid unlimited-color-layout">
                         <input id="ColorPicker1" type="color" value="#006666" name="Background"><input
                              id="ColorPicker2" type="color" value="#FF6150" name="Background">
                    ...
                    <ul class="layout-grid customizer-color">
                         <li class="color-layout" data-attr="color-1" data-primary="#006666" data-secondary="#FF6150">
                              <div></div>
                         </li>
                         <li class="color-layout" data-attr="color-2" data-primary="#1D5B79" data-secondary="#A16B56">
                              <div></div>
                         </li>
                         ...
                         <li class="color-layout" data-attr="color-5" data-primary="#423964" data-secondary="#FFA47A">
                              <div></div>
                         </li>
