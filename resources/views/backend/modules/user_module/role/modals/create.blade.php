...
<div class="modal-header">
     <h6 class="modal-title" id="exampleModalLabel">Role User</h6>
     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
     <form action="{{ route('admin.user-module.role.create') }}" method="POST" class="ajax-form">
          @csrf
                         ...
                         <div class="col-12 col-md-3 my-2">
                              <div class="permission_block p-1">
                                   <label class="module-header mb-0 d-flex align-items-center">
                                        <input type="checkbox" class="module_check me-2" name="permission[]" value="{{ $module->permissions->where('key', $module->key)->first()->id }}" />
                                   ...
                                   <ul class="sub_module_block mt-2 ps-3">
                                        ...
                                        <li class="sub-permission-item">
                                             <label class="mb-0 d-flex align-items-center">
                                                  <input type="checkbox" class="sub_module_check me-2" name="permission[]" disabled value="{{ $permission->id }}" />
